      ...
      <div className="container relative text-center px-4 md:px-6">
        <div className="max-w-3xl mx-auto">
          <h2 className="text-3xl md:text-5xl font-bold text-white mb-6">
            {cta.title} <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-400 to-blue-300">{cta.highlight}</span>؟
          </h2>
          ...
          <div className="flex flex-col sm:flex-row justify-center gap-4 mb-8">
            ...
            <a
              ...
              className="inline-flex items-center justify-center gap-3 bg-blue-500 hover:bg-blue-600 text-white px-8 py-4 rounded-full font-bold text-lg transition-all duration-300"
            >
