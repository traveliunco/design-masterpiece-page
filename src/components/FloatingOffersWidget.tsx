      ...
      {!isOpen && (
        ...
        >
          <button
            ...
            className="widget-drag-handle glass-premium rounded-2xl px-6 py-4 shadow-luxury border border-white/20 hover:scale-105 transition-all group"
          >
            <div className="flex items-center gap-3">
              ...
              <div className="text-right">
                <div className="text-white font-bold text-sm">عروض حصرية</div>
        ...
        >
          <div className="glass-premium rounded-3xl shadow-luxury border border-white/20 w-[380px] max-h-[600px] overflow-hidden">
            ...
            <div className="overflow-y-auto max-h-[500px] p-4 space-y-4">
                ...
                >
                  <div className="relative overflow-hidden rounded-2xl bg-white/5 hover:bg-white/10 transition-all border border-white/10 hover:border-luxury-gold/50 hover:shadow-glow-gold">
                    ...
                    <div className="relative h-40 overflow-hidden">
                      ...
                      {/* Badge */}
                      {offer.badge && (
                        <div className="absolute top-3 left-3 bg-luxury-gold text-luxury-navy px-3 py-1 rounded-full text-xs font-bold">
                          {offer.badge}
                        </div>
                      )}
                    ...
                    <div className="p-4">
                      ...
                      <div className="flex items-center justify-between">
                        <div>
                          ...
                          {offer.oldPrice && (
                            <div className="text-white/40 text-sm line-through">{offer.oldPrice}</div>
                          )}
                        </div>
              ...
              <Link
                to="/offers"
                className="block p-4 text-center bg-white/5 hover:bg-white/10 rounded-2xl border border-white/10 hover:border-luxury-teal transition-all group"
              >
