      ...
      <div className="container relative px-4 md:px-6">
        ...
        <div className="text-center max-w-3xl mx-auto mb-16">
          ...
          <h2 className="text-3xl md:text-5xl font-bold text-luxury-navy mb-6">
            عملاؤنا <span className="text-blue-500">يخبروكم</span>
          </h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-16">
          {testimonials.map((testimonial) => (
            <div
              key={testimonial.id}
              className="group bg-white rounded-2xl p-6 border border-gray-100 shadow-sm hover:shadow-xl hover:border-blue-500/30 transition-all duration-500 hover:-translate-y-1"
            >
              {/* Stars */}
