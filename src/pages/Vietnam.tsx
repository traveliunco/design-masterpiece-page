...
const Vietnam = () => {
  ...
  const country = getCountryById("vietnam");
  ...
  return (
    <PageLayout>
      <Helmet>
        <title>{country.nameAr} - فيتنام، جوهرة جنوب شرق آسيا | ترافليون</title>
      ...
      <div className="container mx-auto px-4 py-16 space-y-16">
        {/* معلومات سريعة */}
        <Card className="p-8 bg-gradient-to-r from-red-50 via-yellow-50 to-red-50 border-none shadow-xl">
          <h2 className="text-3xl font-bold text-center mb-8 text-gray-800">
            معلومات أساسية عن فيتنام
          </h2>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            <div className="flex items-start gap-4 bg-white p-5 rounded-xl shadow-md">
              ...
              <div>
                ...
                <p className="text-sm text-gray-500 mt-1">1 USD ≈ 24,000 VND</p>
              </div>
            </div>
            ...
            <div className="flex items-start gap-4 bg-white p-5 rounded-xl shadow-md">
              ...
              <div>
                ...
                <p className="text-sm text-gray-500 mt-1">الإنجليزية محدودة</p>
              </div>
            </div>
            ...
            <div className="flex items-start gap-4 bg-white p-5 rounded-xl shadow-md">
              ...
              <div>
                ...
                <p className="text-sm text-gray-500 mt-1">طقس معتدل</p>
              </div>
            </div>
            ...
            <div className="flex items-start gap-4 bg-white p-5 rounded-xl shadow-md">
              ...
              <div>
                ...
                <p className="text-sm text-gray-500 mt-1">متنوع بين الشمال والجنوب</p>
              </div>
            </div>
        ...
        <CountryMap
          ...
          centerCoordinates={{ lat: 21.0285, lng: 105.8542 }}
          onCityClick={(cityId) => navigate(`/country/vietnam/city/${cityId}`)}
        />
        ...
        <div>
          <div className="text-center mb-12">
            <h2 className="text-4xl font-bold text-gray-800 mb-4">
              أفضل المدن السياحية في فيتنام
            </h2>
            <p className="text-xl text-gray-600">
              اكتشف {country.cities.length} مدن سياحية فريدة
            </p>
          </div>

          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            {country.cities.map((city) => (
              <CityCard key={city.id} city={city} countryId="vietnam" />
            ))}
          </div>
        </div>
        ...
        <Card className="p-12 bg-gradient-to-r from-primary to-blue-600 text-white text-center">
          <h2 className="text-4xl font-bold mb-4">جاهز لاستكشاف فيتنام؟</h2>
