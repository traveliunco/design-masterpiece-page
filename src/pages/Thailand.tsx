...
const Thailand = () => {
  ...
  const country = getCountryById("thailand");
  ...
  return (
    <PageLayout>
      <Helmet>
        <title>{country.nameAr} - تايلاند، أرض الابتسامات | ترافليون</title>
      ...
      <div className="container mx-auto px-4 py-16 space-y-16">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            <div className="flex items-start gap-4 bg-white p-5 rounded-xl shadow-md">
              ...
              <div>
                ...
                <p className="text-sm text-gray-500 mt-1">1 USD ≈ 33 THB</p>
              </div>
            </div>
            ...
            <div className="flex items-start gap-4 bg-white p-5 rounded-xl shadow-md">
              ...
              <div>
                ...
                <p className="text-sm text-gray-500 mt-1">الإنجليزية منتشرة في المناطق السياحية</p>
              </div>
            </div>
            ...
            <div className="flex items-start gap-4 bg-white p-5 rounded-xl shadow-md">
              ...
              <div>
                ...
                <p className="text-sm text-gray-500 mt-1">رطوبة عالية في الصيف</p>
              </div>
            </div>
        ...
        <CountryMap
          ...
          centerCoordinates={{ lat: 13.7563, lng: 100.5018 }}
          onCityClick={(cityId) => navigate(`/country/thailand/city/${cityId}`)}
        />
        ...
        <div>
          <div className="text-center mb-12">
            <h2 className="text-4xl font-bold text-gray-800 mb-4">
              أفضل المدن السياحية في تايلاند
            </h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            {country.cities.map((city) => (
              <CityCard key={city.id} city={city} countryId="thailand" />
            ))}
          </div>
        </div>
        ...
        <Card className="p-12 bg-gradient-to-r from-primary to-blue-600 text-white text-center">
          <h2 className="text-4xl font-bold mb-4">جاهز لاستكشاف تايلاند؟</h2>
