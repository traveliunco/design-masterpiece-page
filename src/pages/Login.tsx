      ...
      <div className="container py-8 md:py-20 flex items-center justify-center min-h-[70vh] md:min-h-[80vh]">
        <Card className="w-full max-w-md shadow-2xl border-0">
          <CardHeader className="text-center pb-2">
            ...
            <CardTitle className="text-xl md:text-2xl font-bold">لوحة التحكم</CardTitle>
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              <div className="space-y-2">
                ...
                <div className="relative">
                  ...
                  <Input id="email" name="email" type="email" placeholder="admin@traveliun.com" value={formData.email} onChange={handleInputChange} className="pr-10" dir="ltr" />
                </div>
              </div>
