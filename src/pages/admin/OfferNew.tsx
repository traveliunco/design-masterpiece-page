/**
 * صفحة إضافة عرض سفر جديد - لوحة التحكم
 */
    ...
    <div className="space-y-6">
      ...
      <div className="flex items-center gap-4">
        ...
        <div>
          ...
          <p className="text-muted-foreground">أضف عرض سياحي جديد للعرض على الموقع</p>
        </div>
      </div>
        ...
        <div className="lg:col-span-2 space-y-6">
            ...
            <CardContent className="space-y-4">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div className="space-y-2">
                  ...
                  <Input
                    ...
                    placeholder="عرض ماليزيا الصيفي - خصم 20%"
                  />
                </div>
                <div className="space-y-2">
                  ...
                  <Input
                    ...
                    onChange={(e) => {
                      ...
                      setFormData({ ...formData, title_en: val, slug: generateSlug(val) });
                    }}
                    placeholder="Malaysia Summer Deal - 20% Off"
                  />
                </div>
              </div>
              ...
              <div className="space-y-2">
                ...
                <Textarea
                  ...
                  rows={3}
                  placeholder="وصف تفصيلي للعرض وما يشمله..."
                />
              </div>
          ...
          <Card>
            ...
            <CardContent className="space-y-4">
              ...
              <div className="space-y-2">
                <Label>مدة الرحلة (مثال: 7 ليالي / 8 أيام)</Label>
                <Input
          ...
          <Card>
            ...
            <CardContent className="space-y-4">
              <div className="flex items-center justify-between">
                <Label htmlFor="is_active" className="flex items-center gap-2">تفعيل العرض</Label>
