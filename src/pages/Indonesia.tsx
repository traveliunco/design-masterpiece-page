...
const Indonesia = () => {
  ...
  const country = getCountryById("indonesia");
  ...
  return (
    <PageLayout>
      <Helmet>
        <title>{country.nameAr} - إندونيسيا، جنة الجزر | ترافليون</title>
      ...
      <div className="container mx-auto px-4 py-16 space-y-16">
        {/* معلومات سريعة */}
        <Card className="p-8 bg-gradient-to-r from-red-50 via-white to-red-50 border-none shadow-xl">
          <h2 className="text-3xl font-bold text-center mb-8 text-gray-800">
            معلومات أساسية عن إندونيسيا
          </h2>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            <div className="flex items-start gap-4 bg-white p-5 rounded-xl shadow-md">
              ...
              <div>
                ...
                <p className="text-sm text-gray-500 mt-1">1 USD ≈ 15,700 IDR</p>
              </div>
            </div>
            ...
            <div className="flex items-start gap-4 bg-white p-5 rounded-xl shadow-md">
              ...
              <div>
                ...
                <p className="text-sm text-gray-500 mt-1">الإنجليزية في بالي</p>
              </div>
            </div>
            ...
            <div className="flex items-start gap-4 bg-white p-5 rounded-xl shadow-md">
              ...
              <div>
                ...
                <p className="text-sm text-gray-500 mt-1">عند الوصول - 30 يوماً</p>
              </div>
            </div>
            ...
            <div className="flex items-start gap-4 bg-white p-5 rounded-xl shadow-md">
              ...
              <div>
                ...
                <p className="text-sm text-gray-500 mt-1">طقس جاف ومشمس</p>
              </div>
            </div>
            ...
            <div className="flex items-start gap-4 bg-white p-5 rounded-xl shadow-md">
              ...
              <div>
                ...
                <p className="text-sm text-gray-500 mt-1">رطوبة عالية</p>
              </div>
            </div>
        ...
        <CountryMap
          ...
          centerCoordinates={{ lat: -6.2088, lng: 106.8456 }}
          onCityClick={(cityId) => navigate(`/country/indonesia/city/${cityId}`)}
        />
        ...
        <div>
          <div className="text-center mb-12">
            <h2 className="text-4xl font-bold text-gray-800 mb-4">
              أفضل المدن السياحية في إندونيسيا
            </h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {country.cities.map((city) => (
              <CityCard key={city.id} city={city} countryId="indonesia" />
            ))}
          </div>
        </div>
        ...
        <Card className="p-12 bg-gradient-to-r from-primary to-blue-600 text-white text-center">
          <h2 className="text-4xl font-bold mb-4">جاهز لاستكشاف إندونيسيا؟</h2>
