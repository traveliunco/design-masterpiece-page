...
const Register = () => {
  ...
  return (
    <PageLayout pageTitle="إنشاء حساب">
      <div className="container py-6 md:py-12 flex items-center justify-center min-h-[70vh] md:min-h-[80vh]">
        <Card className="w-full max-w-lg shadow-2xl border-0">
          <CardHeader className="text-center pb-2">
            ...
            <CardTitle className="text-xl md:text-2xl font-bold">إنشاء حساب جديد</CardTitle>
            <CardDescription>انضم إلى ترافليون واحجز رحلة أحلامك</CardDescription>
          </CardHeader>
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              <div className="grid grid-cols-2 gap-4">
                <div className="space-y-2">
                  ...
                  <div className="relative">
                    ...
                    <Input id="firstName" name="firstName" placeholder="أحمد" value={formData.firstName} onChange={handleInputChange} className="pr-10" />
                  </div>
                </div>
                <div className="space-y-2">
                  <Label htmlFor="lastName">الاسم الأخير</Label>
                  <Input id="lastName" name="lastName" placeholder="محمد" value={formData.lastName} onChange={handleInputChange} />
                </div>
              </div>
              ...
              <div className="space-y-2">
                ...
                <div className="relative">
                  ...
                  <Input id="email" name="email" type="email" placeholder="your@email.com" value={formData.email} onChange={handleInputChange} className="pr-10" dir="ltr" />
                </div>
              </div>
              ...
              <div className="space-y-2">
                ...
                <div className="relative">
                  ...
                  <Input id="phone" name="phone" type="tel" placeholder="+966 5XX XXX XXXX" value={formData.phone} onChange={handleInputChange} className="pr-10" dir="ltr" />
                </div>
              </div>
